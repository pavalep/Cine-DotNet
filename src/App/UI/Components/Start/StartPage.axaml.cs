...
public partial class StartPage : global::Avalonia.Controls.UserControl
{
    ...
    private void SetDropZoneActive(bool active)
    {
        ...
        // DropZone is now a plain Border (dashed look is via sibling Rectangle).
        // Just animate the background fill on drag-over.
        DropZone.Background = active
            ? new SolidBrush(AvColor.FromArgb(31, 201, 169, 110))   // accent-dim
            : null;
    }
    ...
    private void OnGlobalDragEnter(object? sender, DragEventArgs e)
    {
        ...
        if (DropTarget is not null) DropTarget.IsVisible = true;
    }
