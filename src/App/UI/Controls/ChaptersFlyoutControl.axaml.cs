...
/// </summary>
public partial class ChaptersFlyoutControl : AvaloniaUserControl
{
    private MainViewModel? _viewModel;
    private FlyoutManager? _flyoutManager;
    private FlyoutOverlayControl? _overlay;

    public ChaptersFlyoutControl()
    {
        InitializeComponent();
    ...
    private void OnChaptersMenuClick(object? sender, RoutedEventArgs e)
    {
        ...
        _flyoutManager?.ShowFlyout("chapters", BtnChapters, content, true,
            (a, c, p) =>
            {
                _overlay.OnBackgroundDismissed -= OnOverlayDismissed;
                _overlay.OnBackgroundDismissed += OnOverlayDismissed;
                _overlay.ShowContent(a, c, p);
            });
    }
