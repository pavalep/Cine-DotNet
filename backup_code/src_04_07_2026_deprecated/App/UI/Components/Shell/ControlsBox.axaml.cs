...
public partial class ControlsBox : AvaloniaUserControl
{
    ...
    public VideoTrackSelector? VideoTrackSelector => VideoTrackField;
    ...
    public IFlyoutService? FlyoutManager
    {
        ...
        set
        {
            ...
            if (VideoTrackField != null) VideoTrackField.FlyoutManager = value;
        }
    }
    ...
    {
        VideoTrackField?.UpdateState(hasMultipleVideoTracks);
