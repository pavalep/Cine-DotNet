...
public partial class MainWindow
{
    ...
    private void OnWindowInitialized()
    {
        ...
        _viewModel = new MainViewModel(player, sessionService, playlistService,
            ...
            rendererService, mediaFileService, dragDropService, fileDialogService, featureService, licensingService);
        DataContext = _viewModel;

        _viewModel.OnDropResult += (_, msg) =>
            ShowOsdNotification(MaterialIconKind.FileVideo, msg);
