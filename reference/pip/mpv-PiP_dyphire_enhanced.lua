-- SOURCE: https://github.com/dyphire/mpv-scripts/blob/main/pip.lua
-- PROJECT: mpv-scripts by dyphire (enhanced fork of Wanakachi/WatanabeChika)
--
-- KEY INSIGHT: Enhanced version adds configurable autofit/geometry,
-- separate restore values, geometry delay timer to avoid race conditions,
-- keepaspect-window handling. More robust state save/restore.
--
